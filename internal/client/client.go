...
func Run(
	...
	return RunWithReady(ctx, providerName, roomURL, keyHex, socksPort, socksHost, socksUser, socksPass, nil, clientName )
}
...
func RunWithReady(
	...
	for peerID := range 1 {
		if err := c.addPeer(runCtx, providerName, roomURL, peerID, cancel, clientName); err != nil {
